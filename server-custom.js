...
function getSTTConfig() {
  ...
  return { provider: "deepgram", wsUrl: `wss://api.deepgram.com/v1/listen?model=nova-2&language=${language}&punctuate=true&interim_results=true&endpointing=800&vad_events=true&diarize=true&utterance_end_ms=1500`, protocols: ["token", k] };
}
